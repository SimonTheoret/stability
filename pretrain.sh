...
#SBATCH --mem=16000M                                        # Ask for 32 GB of RAM
#SBATCH --time=0-01:30:00                                   # Duration: max 1.5 hour
...
pip install numpy scikit-learn scipy --no-index
...
rsync -av $SLURM_TMPDIR/checkpoints/ $INIT_DIR/stability/checkpoints/
